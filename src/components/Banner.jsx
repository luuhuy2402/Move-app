...
export default function Banner() {
    ...
    bg-banner bg-center bg-no-repeat bg-cover relative"
        >
                ...
                <div className="flex flex-col space-y-5 items-baseline w-[50%]">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="text-white">
                            ...
                            elit. In quidem fugit cum expedita explicabo porro
                            error labore officiis! Deleniti ipsa necessitatibus
                            et, fugiat velit nobis veritatis consequatur?
                            Adipisci esse cumque commodi fuga sed excepturi
                            autem consequatur, accusamus, reprehenderit
                            voluptatum, aperiam earum. Sit minus maxime quis
                            reiciendis quae corrupti, iure labore.
                        </p>
